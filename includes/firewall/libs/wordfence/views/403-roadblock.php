...
<body>
	...
	<p>A potentially unsafe operation has been detected in your request to this site, and has been blocked by Titan Security.</p>
...
<?php if ($urlParamsToWhitelist): ?>
	...
	<form id="whitelist-form" action="<?php echo htmlentities($waf->getRequest()->getPath(), ENT_QUOTES, 'utf-8') ?>" method="post">
		...
		<p id="error" style="color: #dd422c; font-weight: bold; display: none"><em>Something went wrong whitelisting this request. You can try setting the Firewall Status to Learning Mode under Web App Firewall in the Titan Security menu, and retry this same action.</em></p>
	</form>
	<script>
...
<?php endif ?>
	...
	<p style="color: #999999;margin-top: 2rem;"><em>Generated by Titan Security at <?php echo gmdate('D, j M Y G:i:s T', wfWAFUtils::normalizedTime()); ?>.<br>Your computer's time: <script type="application/javascript">document.write(new Date().toUTCString());</script>.</em></p>
</body>
</html>