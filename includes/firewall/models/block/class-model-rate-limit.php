...
class Rate_Limit {
	...
	public static function globalRateLimit()
	{
		...
		if( $_cachedGlobal === null ) {
			$_cachedGlobal = new \WBCR\Titan\Firewall\Model\Rate_Limit(self::TYPE_GLOBAL);
		}
	...
	public static function crawlerViewsRateLimit()
	{
		...
		if( $_cachedCrawlerViews === null ) {
			$_cachedCrawlerViews = new \WBCR\Titan\Firewall\Model\Rate_Limit(self::TYPE_CRAWLER_VIEWS);
		}
	...
	public static function crawler404sRateLimit()
	{
		...
		if( $_cachedCrawler404s === null ) {
			$_cachedCrawler404s = new \WBCR\Titan\Firewall\Model\Rate_Limit(self::TYPE_CRAWLER_404S);
		}
	...
	public static function humanViewsRateLimit()
	{
		...
		if( $_cachedHumanViews === null ) {
			$_cachedHumanViews = new \WBCR\Titan\Firewall\Model\Rate_Limit(self::TYPE_HUMAN_VIEWS);
		}
	...
	public static function human404sRateLimit()
	{
		...
		if( $_cachedHuman404s === null ) {
			$_cachedHuman404s = new \WBCR\Titan\Firewall\Model\Rate_Limit(self::TYPE_HUMAN_404S);
		}
	...
	public static function visitorType()
	{
		...
		if( $_cachedVisitorType === null ) {
			$_cachedVisitorType = ((isset($_SERVER['HTTP_USER_AGENT']) && wfCrawl::isCrawler($_SERVER['HTTP_USER_AGENT'])) || empty($_SERVER['HTTP_USER_AGENT']) ? \WBCR\Titan\Firewall\Model\Rate_Limit::VISITOR_TYPE_CRAWLER : \WBCR\Titan\Firewall\Model\Rate_Limit::VISITOR_TYPE_HUMAN);
		}
