...
<h2 class="wtitan-modal__title">
	<?php _e('Optimize Titan Firewall', 'anti-spam') ?>
</h2>
...
<div class="wtitan-modal__content">
	...
	<?php else: ?>
		...
		<p><?php _e('You can proceed with the installation and we will include this from within our <code>titan-firewall.php</code> file which should maintain compatibility with your site, or you can opt to override the existing PHP setting.', 'titan'); ?></p>
		<ul id="wtitan-include-prepend" class="wtitan-switch">
			<li class="wtitan-active" data-option-value="include"><?php _e('Include', 'titan'); ?></li>
			<li data-option-value="override"><?php _e('Override', 'titan'); ?></li>
		</ul>
	<?php endif; ?>
	...
	<div class="wtitan-modal-footer">
		<ul class="wtitan-flex-horizontal wtitan-flex-full-width">
			<li class="wtitan-download-instructions"><?php _e('Once you have downloaded the files, click Continue to complete the setup.', 'titan'); ?></li>
